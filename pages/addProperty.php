    ...
    <form class="mainForm" action="">
        ...
        <div class="flexContainer formArea">
            <div class="thirdWidth">
                ...
                <div>
                    <select name="select" id="cats" class="select"></select>
                    <select name="select" id="subcat" class="select"></select>
                </div>
            </div>
        ...
        <div class="flexContainer formArea dropsContainer">
            <div class="halfWidth">
                ...
                <div class="drop-area" id="headArea">
                    ...
                    <input type="file" name="propFiles[]" id="head-input-file" hidden multiple />
                </div>
            ...
            <div class="halfWidth">
                ...
                <div class="drop-area" id="dArea">
                    ...
                    <input type="file" name="propHeader" id="input-file" hidden/>
                </div>
                <div id="preview"></div>
            </div>
        </div>
